...
\begin{enumerate}
    \item An appearance-robust loop closure paradigm that leverages road signage as persistent
          semantic landmarks, overcoming the failure of conventional BoW methods under changing
