...
if old_block in code:
    ...
    print("Code block not found. Checking current snippet:")
    import re
    match = re.search(r'if \(yoloData\.find\(baseFilename\).*?-----------------------------------------\"\);\s*\}', code, re.DOTALL)
    if match:
